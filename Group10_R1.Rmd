...
## Abstarct 
This project will involve a simulation study and a real data analysis with horse-kick death data. The goal of this project 
is in making inference for the mean of the distribution. Several different ways of constructing confidence intervals will be considered.
