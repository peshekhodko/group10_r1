...
For data randomly generated from the Poisson distibution with sample size `n=10`, Parametric distribution works better than nonparametric. 
As sample size grows `n=30` and `n=200`, Nonparametric bootstrap shows better results. CI1 and CI2 show pretty much similar results.  
